...
# Mathajas - added liens thast make photo before starting video feed.
# It solved my problem videofeed not beenig played. 
...
def get_annotated_image():
    try:
        flask_app.remote_control_vector.vector.camera.capture_single_image()
